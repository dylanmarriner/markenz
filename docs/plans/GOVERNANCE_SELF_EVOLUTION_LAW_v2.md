...
Markenz grows in scale/population/knowledge/complexity and evolves in behavior/culture/strategy/society without breaking determinism/auditability/authority boundaries.
...
Includes: Population increase, spatial expansion, resource accumulation, infrastructure scale, knowledge accumulation

Self-growth **adds state**. It does **not** change the rules.
...
Includes: Behavioral strategy shifts, habit formation, cultural drift, skill specialization, governance preference changes
...
All population changes: emit events, affect census and lineage, alter `world_hash`, replay identically
...
- Generation function uses: Markenz root seed, chunk coordinates, deterministic biome + climate rules

Result: Infinite world, zero nondeterminism, identical expansion on replay
...
- Technology emerges via: discovery events, diffusion events, adoption thresholds
...
All parameters: numeric, bounded, logged, reversible via replay
...
Successful strategies: strengthen, propagate genetically or socially
Unsuccessful strategies: weaken, disappear naturally
